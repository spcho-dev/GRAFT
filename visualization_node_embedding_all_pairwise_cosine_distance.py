...
# --- Configuration ---
# Input data file (contains only fold 10 data)
data_file = "./node_embeddings.csv"
output_dir = "./figures"
...
# Plot each KDE and fill the area underneath
for dist, label, color in plot_data:
    # Ensure distance array is not empty before plotting
    if len(dist) > 0:
