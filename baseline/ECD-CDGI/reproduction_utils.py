...
class ECD_CDGINet(torch.nn.Module):
    def __init__(self, args, weights=[0.50, 0.50, 0.50, 0.50]):
        ...
        self.linear_r0 = nn.Linear(hidden_channels, 1)
        self.linear_r1 = nn.Linear(hidden_channels, 1)
        self.linear_r2 = nn.Linear(hidden_channels, 1)
        self.linear_r3 = nn.Linear(hidden_channels, 1)
        ...
        self.convs1 = ECD_CDGIConv(hidden_channels, hidden_channels, kernel='simple', use_graph=True, use_weight=False)
        self.use_bn = True
        self.residual = True
