...
def train(Kfold, dataset, train_label, test_label, val_label, train_id, test_id, val_id, n_graphs, n_neighbors, n_layers, spatial_type,
          max_degree, batch_size, embed_dim, num_heads, d_sp_enc, dff, l2_weights, lr, dropout, loss_mul, optimizer, n_epoch, callbacks_to_add=None, overwrite=True, save_dir=None):
    ...
    config.exp_name = f'TREE_{dataset}_fold_{Kfold+1}'
    ...
    if save_dir is not None:
        ...
        save_path = os.path.join(save_dir, f"TREE_fold_{Kfold+1}.h5")
